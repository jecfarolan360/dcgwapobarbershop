...
class PaymentFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'payment_ibfk_1' => ['type' => 'foreign', 'columns' => ['client_transaction_id'], 'references' => ['client_transaction', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'payment_amount' => 1,
            'payment_date' => '2018-01-09 01:38:51'
        ],
    ];
}
